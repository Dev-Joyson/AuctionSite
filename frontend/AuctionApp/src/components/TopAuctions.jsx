...
const TopAuctions = () => {
  ...
  return (
<div className="flex flex-col items-center my-16 gap-2 text-gray-900">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full px-8">
        {products.map((product) => (
          <div
            key={product.id}
            className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between"
          >
            <img
              src={product.image}
              alt={product.name}
